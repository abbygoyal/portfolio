        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={6} className="project-card">
            <ProjectCards
              ...
              description="This project is an customer management system having functionalities like Search, Pagination, Sort, Filter, Export to CSV. This app is built with React, Node.js, Express, MongoDB and Bootstrap"
              tech="Tech-Stacks"
